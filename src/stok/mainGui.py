...
class Ui_MainWindow(object):
    ...
    def initWindow(self):
        ...
        stock_statistics_layout = QGridLayout()
        ...
        self.m15_button = QPushButton("15")
        self.m30_button = QPushButton("30")
        self.day_button = QPushButton("day")
        self.m15_b_button = QPushButton("15b")
        self.m30_b_button = QPushButton("30b")
        self.day_b_button = QPushButton("dayb")
        ...
        stock_statistics_layout.addWidget(start_date_labek, 0, 0, 1, 1)
        stock_statistics_layout.addWidget(self.start_date_edit, 0, 1, 1, 1)
        stock_statistics_layout.addWidget(end_date_label, 1, 0)
        stock_statistics_layout.addWidget(self.end_date_edit, 1, 1)
        stock_statistics_layout.addWidget(stock_code_label, 2, 0)
        stock_statistics_layout.addWidget(self.stock_code_lineEdit, 2, 1)
        stock_statistics_layout.addWidget(stock_period_label, 3, 0)
        stock_statistics_layout.addWidget(self.time_period_combobox, 3, 1)
        stock_statistics_layout.addWidget(adjustflag_label, 4, 0)
        stock_statistics_layout.addWidget(self.adjustflag_combobox, 4, 1)
        stock_statistics_layout.addWidget(self.m15_button, 5, 0, 1, 1)
        stock_statistics_layout.addWidget(self.m15_b_button, 5, 1, 1, 1)
        stock_statistics_layout.addWidget(self.m30_button, 6, 0, 1, 1)
        stock_statistics_layout.addWidget(self.m30_b_button, 6, 1, 1, 1)
        stock_statistics_layout.addWidget(self.day_button, 7, 0, 1, 1)
        stock_statistics_layout.addWidget(self.day_b_button, 7, 1, 1, 1)
        stock_statistics_layout.addWidget(self.insert_optional_button, 8, 0, 1, 1)
        stock_statistics_layout.addWidget(self.delete_optional_button, 8, 1, 1, 1)
        stock_statistics_layout.addWidget(self.sync_stock_data_button, 9, 0, 1, 1)
        ...
        stock_groupBox.setLayout(stock_statistics_layout)
        settingLayout.addWidget(stock_groupBox)


        # serial receive settings
        serialReceiveSettingsGroupBox = QGroupBox("统计")
